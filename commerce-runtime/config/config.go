...
func FromEnv() Config {
	...
	return Config{
		...
		GatewayBaseURL: firstNonEmpty(os.Getenv("STABLEPAY_GATEWAY_BASE_URL"), "http://127.0.0.1:8080"), GatewayAPIKey: firstNonEmpty(os.Getenv("STABLEPAY_API_KEY"), "stablepay-dev-key"), MerchantTimeout: merchantTimeout, MaxRunnerSteps: maxSteps,
	}
}
