...
func NewSolanaGatewayWithFeePayer(network, endpoint, feePayerAddress string) (gateway.SolanaGateway, error) {
	if _, err := solana.PublicKeyFromBase58(feePayerAddress); err != nil {
