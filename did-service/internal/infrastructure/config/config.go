...
// ResolvePath returns the runtime configuration path. CONFIG_PATH is
// intentionally resolved at process start so local, Docker and Kubernetes
// deployments can use the same binary with different mounted files.
