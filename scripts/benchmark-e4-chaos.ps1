...
$manifest.environment.terminal_execution_reconciler = 'E4-only reconciler calls existing Runner.ResumeEpisode for terminal episodes whose execution marker remains RUNNING; production Runtime source unchanged'
