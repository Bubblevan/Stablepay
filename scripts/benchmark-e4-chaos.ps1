...
$manifest.environment.state_delay_adapter = 'benchmark-only MySQL store decorator holds DISCOVERING, NEGOTIATING, VALIDATING_DELIVERY and RECOVERING; production Runtime code unchanged'
